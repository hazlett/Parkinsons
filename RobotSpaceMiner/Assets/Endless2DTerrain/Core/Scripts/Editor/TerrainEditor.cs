...
public class TerrainEditor : Editor {
    ...
    private SerializedProperty TerrainLeadAmount;
	...
	void OnEnable () {
        ...
        TerrainLeadAmount = terrainDisplayer.FindProperty("terrainLeadAmount");
        MainCamera = terrainDisplayer.FindProperty("MainCamera");
